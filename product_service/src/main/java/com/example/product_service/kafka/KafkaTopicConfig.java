...
public class KafkaTopicConfig {
    ...
    public static final String ORDER_STOCK_RESERVE_TOPIC = "order-stock-reserve-topic";
    @Bean
    ...
    @Bean
    public NewTopic orderStockReserveEvent(){
        return TopicBuilder.name(ORDER_STOCK_RESERVE_TOPIC)
                .partitions(10)
                .replicas(1)
                .build();
    }
